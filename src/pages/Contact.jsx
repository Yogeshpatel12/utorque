const Contact = () => {
  return (
    <div className="min-h-screen pb-4 pt-4 bg-gray-100 flex justify-center items-center">
      <div className="bg-[#0D1028] shadow-lg rounded-lg p-10  w-full mx-4">
              ...
              <div className=" flex flex-col space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className=" hover:bg-[#0D1028] hover:text-white duration-300 transition-all mt-1 block w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    required
                  />
                </div>
                <div>
