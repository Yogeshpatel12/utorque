...
const BackToTopButton = () => {
  ...
  return (
    ...
    } z-40 fixed bottom-2 right-2 xs:bottom-[1.3rem] xs:right-[1.3rem] md:bottom-4 md:right-4 w-8 h-8 flex justify-center items-center rounded-full bg-[#0D1028] cursor-pointer  hover:scale-[1.08] duration-500 text-white`}>
